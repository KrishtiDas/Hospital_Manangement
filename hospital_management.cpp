...
// Function to print the patient data in the hospital 
...
// Function to sort the hospital data by name 
...
// Function to sort the hospital data by namerating 
...
// Comparator function to sort the hospital data by Bed Available 
bool beds(Hospital& A, Hospital& B) 
{ 
	return A.available_beds > B.available_beds; 
} 

// Function to sort the hospital data by Bed Available 
...
{ 
	...
	cout << "Sorted by Available Beds -> "<< endl; 

	PrintHospitalData(hospitals); 
} 

// Comparator function to sort the hospital data by Bed Price 
...
{ 
	...
	cout << "Sorted by Available Beds Price -> "<< endl; 
...
{ 
	// Stores the Hospital data and user data 
	vector<Hospital> hospitals; 

	// Create Objects for hospital and the users 
	Hospital h; 
...
int main() 
{ 
	// Stores hospital data and the user data 
	...
	string locations[] = { "Hyderabad", "Bangalore", 
						" Kolkata ", "Prayagraj" }; 
	int beds[] = { 4, 5, 6, 9 }; 
	float ratings[] = { 5.2, 4.1, 5.6, 5.9 }; 
	string hospital_Contact[] 
		= { "657634XXX7", "398766XXX2", "234565XXX9", 
			"563434XXX4" }; 
